                                        ...
                                        <ul class="shop-w__category-list gl-scroll">
                                            ...
                                            <li>
                                                ...
                                                @foreach ($Categories as $Category )
                                                    <li>
                                                        <a href="#" wire:click='ProductWithCategoryId({{ $Category->id }})'>{{ $Category->name }}</a>
                                                        <span class="category-list__text u-s-m-l-6">(0)</span></li>
                                                    <li>
                                                @endforeach
                                            </ul>
                        ...
                        <div class="shop-p__tool-style">
                            ...
                            <form>
                                <div class="tool-style__form-wrap">
                                    <div class="u-s-m-b-8">
                                        <select class="select-box select-box--transparent-b-2" wire:model='PaginateZise'>
                                            <option value="8">Show: 8</option>
                                            <option  value='12' selected>Show: 12</option>
                                            <option value="16">Show: 16</option>
                                            <option value="28">Show: 28</option>
                                        </select></div>
                                    <div class="u-s-m-b-8"><select class="select-box select-box--transparent-b-2" wire:model='SortBy'>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product-m">
                                        <div class="product-m__thumb">
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="{{ route('show.product' , $product->slug) }}">
