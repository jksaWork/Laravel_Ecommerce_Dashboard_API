                                            ...
                                            <div class="card-body card-dashboard">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($Categories as $key => $client)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <form
                                                                    action="{{ route('categories.destroy', $client->id) }}"
                                                                    id='delete_form_{{ $client->id }}'
                                                                    method="post"
                                                                    style="display: inline-block" >
                                                                    @csrf
                                                                    @method('delete')
                                                                    <a onclick="FireSweetAlert({{ $client->id }})"
                                                                        href="#"
                                                                        class="btn btn-sm btn-icon
                                                                    btn-danger"><i class="la la-trash"></i></a>
                                                                </form>
                                                                <a  class="btn btn-sm btn-icon btn-light" href="{{ route('categories.show' , encrypt($client->id) ) }}">
                                                                    change status
                                                                </a>
                                                            </td>
                                                        </tr>
